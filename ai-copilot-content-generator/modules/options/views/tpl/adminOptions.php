			...
			<div class="wbw-tab-content" id="content-tab-<?php echo esc_attr($key); ?>">
				<form id="waicOptionsForm<?php echo esc_attr($key); ?>" data-group="<?php echo esc_attr($key); ?>">
					...
					<div class="wbw-buttons-form row">
						<div class="col-12">
							<button class="wbw-button wbw-button-form wbw-button-main wbw-button-save"><?php esc_html_e('Save', 'ai-copilot-content-generator'); ?></button>
							<button class="wbw-button wbw-button-form wbw-button-minor wbw-button-cancel"><?php esc_html_e('Cancel', 'ai-copilot-content-generator'); ?></button>
							<button class="wbw-button wbw-button-form wbw-button-leer wbw-button-restore"><?php esc_html_e('Restore by default', 'ai-copilot-content-generator'); ?></button>
						</div>
					</div>
				</form>
			</div>
