...
<div class="wbw-settings-form row">
	...
	<div class="wbw-settings-fields col-10">
		...
		<?php 
			WaicHtml::hidden('fields[' . $curField . '][key]', array('value' => 'number'));
...
<div class="wbw-settings-form row">
	<div class="wbw-settings-label col-2"><?php esc_html_e('Range', 'ai-copilot-content-generator'); ?></div>
	<div class="wbw-settings-fields col-10">
		<img src="<?php echo esc_url(WAIC_IMG_PATH . '/info.png'); ?>" class="<?php echo esc_attr($tooltip); ?>" title="<?php esc_html_e('Numeric input field with optional min/max limits.', 'ai-copilot-content-generator'); ?>">
		<?php 
			WaicHtml::number('fields[' . $curField . '][min]', array(
				'value' => WaicUtils::getArrayValue($fData, 'min'),
			));
			?>
		<div class="wbw-settings-label">-</div>
		<?php 
			WaicHtml::number('fields[' . $curField . '][max]', array(
				'value' => WaicUtils::getArrayValue($fData, 'max'),
			));
			?>
	</div>
</div>
