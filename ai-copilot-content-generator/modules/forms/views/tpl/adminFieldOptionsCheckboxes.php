...
<div class="wbw-settings-form row">
	...
	<div class="wbw-settings-fields col-10">
		...
		<?php 
			WaicHtml::hidden('fields[' . $curField . '][key]', array('value' => 'checkboxes'));
...
<div class="wbw-settings-form row">
	<div class="wbw-settings-label col-2"><?php esc_html_e('Choices', 'ai-copilot-content-generator'); ?></div>
	<div class="wbw-settings-fields col-10">
		<img src="<?php echo esc_url(WAIC_IMG_PATH . '/info.png'); ?>" class="<?php echo esc_attr($tooltip); ?>" title="<?php esc_html_e('Enter each choice on a new line.', 'ai-copilot-content-generator'); ?>">
		<?php 
			WaicHtml::textarea('fields[' . $curField . '][choices]', array(
				'value' => WaicUtils::getArrayValue($fData, 'choices'),
				'rows' => 4,
			));
			?>
	</div>
