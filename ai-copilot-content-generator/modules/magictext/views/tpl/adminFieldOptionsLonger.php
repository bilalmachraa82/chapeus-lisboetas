...
$props = $this->props;
$options = WaicUtils::getArrayValue($props['fields'], 'longer', array(), 2);
...
<div class="wbw-settings-form row">
	...
	<div class="wbw-settings-fields col-10">
		...
		<?php
		WaicHtml::text('fields[longer][name]', array(
...
<div class="wbw-settings-form row wbw-settings-top">
	<div class="wbw-settings-label col-2"><?php esc_html_e('Fix longer', 'ai-copilot-content-generator'); ?></div>
	<div class="wbw-settings-fields col-10">
		...
		<?php
		WaicHtml::textarea('fields[longer][text]', array(
